...
async function getPokemon() {
  ...
  for (let i = 0; i < 8; i++) {
    ...
    if (imagem) {
      // Adiciona o HTML da imagem na variável "itens"
      let div = document.createElement("div");
      if (primeiro) {
        //Pega lista de classes e adiciona as classes
        div.classList.add("active");
        // Marca que o primeiro item já foi adicionado
        primeiro = false;
      }
      // Adiciona o HTML da imagem na variável "itens"
      ...
      img.alt = "Imagem do Pokémon " + name + " - " + atributo;
      img.title = "Imagem do Pokémon " + name + " - " + atributo;
      //Adicionar a imagem na div
      div.appendChild(img);
      //Filho carousel apendChild div
